...
export const organizationAccountSchema = zod.object({
  ...
  url: websiteSchema,
  description: zod.string().max(300, 'Description must be less than 300 characters').nullable(),
  ...
  certificate_info_id: zod.number().nullable(),
  org_profile_vector: zod.string().nullable(),
  org_history_vector: zod.string().nullable(),
  org_context_vector: zod.string().nullable(),
