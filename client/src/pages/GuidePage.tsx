...
function GuidePage() {
  ...
  const mobileSectionButtonRefs = useRef<Record<string, HTMLButtonElement | null>>({});
  ...
  useEffect(() => {
    mobileSectionButtonRefs.current[activeSection]?.scrollIntoView({
      behavior: 'smooth',
      block: 'nearest',
      inline: 'nearest',
    });
  ...
  const timelineStepsOrganization = useMemo(
    () => [
      ...
      },
      {
        ...
        description: 'Decide whether applicants are accepted automatically (open) or require your manual acceptance (review-based). You can also close a posting at any time to stop new applications',
      },
      {
      ...
      },
      {
        ...
        description: 'After the event, mark which enrolled volunteers actually showed up. Only attended volunteers have these hours counted in their certificates.',
      },
    ],
    [],
  );
  ...
  const getTimelineStep = (step: { id: string; icon: LucideIcon; title: string; description: string }, index: number) => {
    ...
    return (
      <div key={step.id} className="mb-2">
        <div className="lg:hidden flex flex-col items-center pt-3">
          <div className="relative z-10 bg-linear-to-br from-primary to-secondary rounded-full p-3 shadow-lg text-white -mb-3">
            <SideIcon size={20} />
          </div>
          <Card className="w-full max-w-lg hover:shadow-lg transition" padding>
        ...
        <div className="hidden lg:grid lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-2 flex justify-center items-center relative">
            <div className="hidden lg:block absolute h-full border-l-2 border-dashed border-primary-focus top-2 bottom-0" />
  ...
  return (
    <main className="h-screen flex flex-col">
      ...
      <div className="grow min-h-0 bg-base-200 flex flex-col">
        <div className="flex flex-col gap-0 lg:gap-6 min-h-0 flex-1">

          <div className="lg:hidden sticky top-0 z-20 mx-auto bg-base-100 w-full shadow-sm">
            <div className="flex items-center gap-2 px-4 py-4 overflow-x-auto scrollbar-hidden w-full">
              {sections.map(section => (
                <button
                  ref={(element) => {
                    mobileSectionButtonRefs.current[section.id] = element;
                  }}
                  type="button"
                  key={`mobile-${section.id}`}
                  onClick={() => sectionScrollTo(section.id)}
                  className={`btn btn-sm rounded-full normal-case border-0 ${activeSection === section.id ? 'bg-linear-to-r from-primary to-secondary text-white' : 'hover:bg-base-300 text-base-content'}`}
                >
                  {section.label}
                </button>
              ))}
          ...
          <div ref={scrollContainerRef} className="overflow-y-scroll flex-1 min-h-0">
            <div className="md:container mx-auto px-3 py-0 md:p-2">
              <div className="flex items-start w-full gap-6">
                <aside className="hidden lg:block sticky top-6 shrink-0 w-64 p-4 self-start max-h-[calc(100vh-6rem)] overflow-y-auto">
                ...
                <main className="grow">
                  ...
                  <section className="relative rounded-3xl bg-base-100 p-10 text-base-content overflow-visible mb-2 mt-4">
                  ...
                  <section id="overview" className="mt-6 scroll-mt-24 bg-base-200 rounded-3xl p-6 lg:p-10">
                  ...
                  <section id="volunteers" className="py-8 scroll-mt-24 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
                  ...
                  <section id="organizations" className="py-8 scroll-mt-24 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
                  ...
                  <section id="postings" className="py-8 scroll-mt-24 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
                  ...
                  <section id="crises" className="py-20 scroll-mt-24 bg-base-200 rounded-3xl p-6 lg:p-10 mb-10">
                    <div className="mb-6">
                    ...
                    <div className="mb-6">
                      ...
                      <p className="text-base-content/80">A crisis is a specific real-world event that requires immediate action and help. The Willing admin can create crises and pin them to highlight urgency. Pinned crises appear on the volunteers home page. Organizations can add a crisis as a tag to their postings</p>
                    </div>
                  ...
                  <section id="certificates" className="py-8 scroll-mt-24 bg-base-100 rounded-3xl p-6 lg:p-10 mb-10">
                    <div className="mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-base-content/80">Certificates have unique tokens and can be viewed read-only by anyone. No log in is required to confirm the validity of a certificate. The only step is to enter the token in the "Verify Certificate" section.</p>
                    </div>
                  </section>

                  <section id="faq" className="py-10 scroll-mt-24 bg-base-200 rounded-3xl p-6 lg:p-10 mb-10">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        ['How is attendance tracked?', 'Organizations mark attendance after an event, and only once you are marked as attended do those hours count toward your certificate.'],
